class Question {
  ...
  display(){
    ...
    this.question.html("What has 88 keys but cannot open a door?");
    this.option1.html("a)A Keyboard");
    this.option2.html("b)A Tablet");
    this.option3.html("c)A Piano");
    this.option4.html("d)A Smartphone");
